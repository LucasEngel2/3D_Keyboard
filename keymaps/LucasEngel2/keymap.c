...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOD2] = LAYOUT(
        ...
        KC_GRV,     KC_LBRC,    KC_RBRC,    KC_SLSH,    _______,    _______,    KC_BSLS,    KC_EQL,     KC_MINS,    KC_LSFT,
        _______,    _______,    KC_ALT,     KC_TAB,     _______,    _______,    _______,    _______,    _______,    _______,
